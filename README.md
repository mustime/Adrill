...
Furthermore, Adrill make it more easier when it comes to zygote[64] injection(see for workaround at [ptrace_wrapper.cc](https://github.com/mustime/Adrill/blob/main/source/ptrace_wrapper.cc#L184)).
...
First you need to update the submodle: 

```
git submodule update --init
```

Say you want to use Adrill in Android emulators, i.e., a x86 executable:
